                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    ...
                    <div class="row mg-b-20">
                        <div class="col-lg-6">
                            ...
                            <label for="inputName" class="control-label" >رقم </label>
                                <input type="text" class="form-control form-control-sm mg-b-20" id="mopail_number" name="mopail_number"required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"onchange="finalTotal('total1')" onchange="calTotal()">
