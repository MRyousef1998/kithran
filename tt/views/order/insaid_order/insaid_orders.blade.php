...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">طلبيات بيع داخلي</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                   الطلبيات </span>
            </div>
        </div>
...
@section('content')
    ...
    <div class="row">
      ...
      <div class="col-xl-12">
                    ...
                    <a href="add_insaid_order" class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                                > <i
                                class="fas fa-plus"></i>&nbsp; اضافة طلبية بيع داخلي جديدة </a>
                    </div>
<form action="/insaid_order_serch" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                                                    ...
                                                    @foreach ($orders as $x)
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <a class="dropdown-item" href="ExportOrderDetails/add_produ_to_order/{{$x->id}}"
                                                                    data-order_id="{{ $x->id }}"
                                                                     ...
                                                                     اضافة منتجات
                                                                                            ...
                                                                                            <a class="dropdown-item" href="{{URL::to("add_invoices/".'2'."/".$x->id)}}"
                                                                    data-order_id="{{ $x->id }}"
