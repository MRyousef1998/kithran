			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='import_order/'.$id='1') }}">طلبيات استيراد </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='product-details') }}">طلبيات تصدير</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">شهرام </a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">حميد</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='rangeslider') }}">حبيب</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='alerts') }}">اندورا</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='avatar') }}">ايطاليا</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='breadcrumbs') }}">يونان </a></li>
