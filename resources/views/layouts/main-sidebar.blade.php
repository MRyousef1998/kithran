			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">@can('الجرودات')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='insaid_order') }}">طلبيات بيع داخلي</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li>@can('الارباح')<a class="slide-item" href="{{ url('/' . $page='user_profile/'.$x->id) }}">{{$x->name}} </a>@endcan</li>
							@endforeach
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">قائمة الفواتير</a></li>@can('الصندوق')@endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li>@can('الجرودات')<a class="slide-item" href="{{ url('/' . $page='shipmentes') }}">قائمة الشحنات</a>@endcan</li>
