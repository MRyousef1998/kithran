                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                            data-toggle="modal" href="#modaldemo8">اضافة شركة</a>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            ...
                            <tbody>
                                <?php $i = 0; ?>
                                @foreach ($productCompany as $x)
                                    <?php $i++; ?>
                                    <tr>
                                        <td>{{ $i }}</td>
                                        <td>{{ $x->company_name }}</td>

                                        <td>{{ $x->country_of_manufacture }}</td>

                                        <td>

                                            <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                data-id="{{ $x->id }}" data-company_name="{{ $x->company_name }}"

                                                data-country_of_manufacture="{{ $x->country_of_manufacture }}"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('companies.store', 'test') }}" method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">بلد الصنع</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="companies/update" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">بلد المنشأ:</label>
                            <input class="form-control" id="country_of_manufacture" name="country_of_manufacture" type="text">
                        </div>
                </div>
                <div class="modal-footer">
