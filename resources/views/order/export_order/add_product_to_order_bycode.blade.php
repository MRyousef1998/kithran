        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/machine_serch_to_export_order_bycode" method="POST" role="search" autocomplete="off">
                        {{ csrf_field() }}
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/add_export_order_one_by_one_bycode"  method="post" name="form"id="form"enctype="multipart/form-data"
                        autocomplete="off">
                        {{ csrf_field() }}
                        {{-- 1 --}}
                        ...
                        <tbody>
                            ...
                            @foreach ($machines as $x)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;vertical-align: middle; width:5"><input type="checkbox"  value="{{ $x->products_id }}" class="box1" id="box1" name="box1"  ></td>
                                    <td  style="text-align: center;vertical-align: middle; background-color:rgb(11, 107, 16);width:5" >P{{ $x->products_id}}</td>
                                    ...
                                    <td style="text-align: center;vertical-align: middle; color:rgb(207, 14, 14); " > <a  >{{1}}</a></td>
                                 ...
                                 <td class="cart-product-quantity"  style="text-align: center;vertical-align: middle;width:15% ;height:15%">
                                    ...
                                    <td class="cart-product-quantity"  style="text-align: center;vertical-align: middle;width:15% ;height:15%">
                                        <div class="input-group" style=" ">
                                            ...
                                            <input type="text" class="qtyy form-control" style="text-align: center;vertical-align: middle;"id="qtyy"  name ="qtyy" value="1" hidden>
